...
Nos referimos a reformar o manipular datos cuando generamos procesos de reestructuración. Muchas veces los datos brutos están en formatos conocidos como __datos de formato largos__ y lo que nosotros necesitamos es obtener __datos de formato ancho__.
...
knitr::kable(S1T[1:10,1:7], caption= "Ejemplo de datos con formato ancho (wide data)")
...
knitr::kable(dtaT[1:10,1:7], caption= "Subconjunto de los datos con formato ancho de frecuencia")
```
...
knitr::kable(dtaTab[1:10,1:7], caption= "Subconjunto de los datos con formato ancho de biomasa")
```
...
knitr::kable(dtaL[1:6,], caption= "Subconjunto de los datos con formato largo de frecuencia")
...
knitr::kable(dtaA[,1:7], caption= "Subconjunto de los datos agregados a parcela")
...
knitr::kable(dtaA2[1:7,], caption= "Subconjunto de los datos agregados a parcela/subparcela/especie")
